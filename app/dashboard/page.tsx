    ...
    <div className="min-h-screen bg-pink-50">
      ...
      <main className="pt-14 lg:pt-0 lg:ml-[280px] min-h-screen">
        <div className="p-4 sm:p-6 lg:p-8">
                    ...
                    <div key={idx} className="flex-1 flex flex-col items-center gap-1 sm:gap-2">
                      <div className="w-full flex justify-center">
                        <motion.div
                          ...
                          className="w-full max-w-[32px] bg-gradient-to-t from-rose-500 to-pink-400 rounded-t-lg min-h-[20px]"
                          style={{ height: `${height}%` }}
                        />
                      </div>
          ...
          {/* Peak Hours - Hidden on small mobile */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <Link
              href="/pdv"
              className="flex items-center gap-2 sm:gap-3 p-3 sm:p-4 bg-gradient-to-r from-rose-500 to-pink-500 text-white rounded-xl hover:from-rose-600 hover:to-pink-600 transition-all card-hover"
            >
            ...
            <Link
              ...
              className="flex items-center gap-2 sm:gap-3 p-3 sm:p-4 bg-white border border-rose-100 rounded-xl hover:border-rose-300 transition-all card-hover"
            >
